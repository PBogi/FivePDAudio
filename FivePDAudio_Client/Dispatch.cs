...
namespace fivepdaudio
{
    class Dispatch
    {
        ...
        {
            Main.OutputDebug("Received callout information");
            ...
            Main.OutputDebug("Finished creating playlist, adding it to dispatch queue");
        ...
        {
            Main.OutputDebug("Received code 4, adding it to dispatch queue");
        ...
        {
            Main.OutputDebug("Received backup information");
            List<string> soundFiles = new List<string>();
            List<string> SearchFiles = AudioLibrary.availableAudio.Where(x => x.StartsWith(@"ATTENTION_ALL_UNITS_GEN/ATTENTION_ALL_UNITS_GENERIC_")).ToList();
            soundFiles.Add(SearchFiles[random.Next(0, SearchFiles.Count)]);
        ...
        {
            Main.OutputDebug("Dispatch playlist received via event from 3rd party, adding it to queue");
